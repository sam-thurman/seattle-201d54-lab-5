...
var myArray5 = [];
var multiplyAB = multiply(multArr[0],multArr[1]);
var finalProd = multiply(multiplyAB[0], multArr[2]);
myArray5[0] = finalProd[0];
myArray5[1] = `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${myArray5[0]}.`;
return myArray5;
}
